		...
		<Layout>
			<div className="min-h-full flex-1 flex flex-col items-center relative">
				...
				<div className="flex-1 flex flex-col gap-5 h-full w-[90%] overflow-y-auto scrollbar-none">
					...
					<div className="h-36 w-60 sm:h-28 sm:w-72 shadow-xl bg-sky-100 border-b-2 border-sky-300 flex flex-col justify-between p-3 ml-5">
						...
						<div className="flex flex-col sm:flex-row sm:items-center gap-3 sm:gap-0 justify-between w-full">
							...
							<button className="h-10 w-24 bg-blue-400 text-white border-b-4 border-blue-500 rounded font-semibold">
								Continue
							</button>
						</div>
