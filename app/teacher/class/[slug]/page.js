			...
			<div className="h-full flex-1 p-16 flex flex-col items-center gap-10">
				<div className="w-full flex flex-col">
					<div className="h-12 flex flex-row items-center">
						<button
							className={`h-full w-28 flex items-center justify-center transform-gpu ease-in-out duration-300 ${
								selectedTab === "stream" &&
				...
				{selectedTab === "stream" && (
					<div className="size-full flex flex-col gap-10 px-32">
						<div className="min-h-44 w-full bg-sky-300 rounded-xl shadow-xl text-3xl font-sans text-white p-5 flex items-end">
							Arabic Class
						</div>
						<div className="w-full flex flex-row gap-10">
							<div className="h-40 w-64 rounded-xl border border-sky-500 shadow-xl flex flex-col justify-around px-5">
							...
							<div className="w-full flex flex-col gap-10">
								<div className="h-80 w-full rounded-xl border border-sky-500 shadow-xl flex flex-col p-7">
									...
									<div className="h-20 w-full flex flex-row items-end justify-between">
				...
				{selectedTab === "classwork" && (
					<div className="h-full w-[55%] flex flex-col overflow-y-auto scrollbar-none">
