    ...
    return (
        <div className="h-screen max-w-screen flex flex-col items-center">
            <div className="h-20 w-full bg-primary bg-opacity-15 flex flex-row justify-between items-center pl-5 pr-10">
                ...
                <Link href={"/login"} className=" h-12 w-28 rounded-2xl border-b-4 border-blue-500 bg-blue-400 font-bold flex items-center justify-center">Sign in</Link>
            </div>
            <div className="grid grid-cols-2 h-full w-full">
                <div className="bg-contain bg-no-repeat bg-center" style={{ backgroundImage: "url('/signup-image.jpeg')" }} />
                <div className="flex flex-col items-center">
                    ...
                    <button className="flex items-center justify-center bg-blue-300 mb-10 min-h-14 w-[450px] rounded-2xl mt-5 border-b-4 border-blue-400 text-xl text-white  font-bold" onClick={handleSignUp}>Sign up, it&apos;s free</button>
                </div>
            </div> 
        </div>
    )
