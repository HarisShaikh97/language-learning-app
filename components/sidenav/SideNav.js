...
export default function SideNav() {
    ...
    return (
        <div className={`h-full ${collapsed ? "w-24" : "w-60"} border-r flex flex-col gap-20 pt-10 relative`}>
            <button className="h-7 w-7 rounded-full border-2 absolute -right-[14px] top-[450px] bg-white flex items-center justify-center" onClick={() => {setCollapsed(!collapsed)}}>
            ...
            <div className="flex-1 flex flex-col">
                {pathname === "/home" ? (
                    <div className="flex flex-row items-center justify-between h-16 bg-gray-100">
                        <div className="flex flex-row gap-5 items-center pl-5">
                            <RectangleStackIcon className="h-7 w-7 text-gray-500" />
                            {!collapsed && <p className="text-lg text-gray-500 font-semibold">Home</p>}
                        </div>
                ...
                {pathname === "/scenarios" ? (
                    <div className="flex flex-row items-center justify-between h-16 bg-gray-100">
                        <div className="flex flex-row gap-5 items-center pl-5">
                            <PresentationChartLineIcon className="h-7 w-7 text-gray-500" />
                            {!collapsed && <p className="text-lg text-gray-500 font-semibold">Scenarios</p>}
                        </div>
                        <div className="h-full w-2 bg-yellow-500 rounded-s-full" />
                    </div>
                ) : (
                ...
                {pathname === "/videos" ? (
                    <div className="flex flex-row items-center justify-between h-16 bg-gray-100">
                        <div className="flex flex-row gap-5 items-center pl-5">
                            ...
                            {!collapsed && <p className="text-lg text-gray-500 font-semibold">Videos</p>}
                        </div>
                        <div className="h-full w-2 bg-yellow-500 rounded-s-full" />
                    </div>
                ) : (
                ...
                {pathname === "/conversations" ? (
                    <div className="flex flex-row items-center justify-between h-16 bg-gray-100">
                        <div className="flex flex-row gap-5 items-center pl-5">
                            ...
                            {!collapsed && <p className="text-lg text-gray-500 font-semibold">Conversations</p>}
                        </div>
                        <div className="h-full w-2 bg-yellow-500 rounded-s-full" />
                    </div>
                ) : (
