...
export default function SideNav() {
	...
	return (
		...
		>
			<button
				className="h-7 w-7 rounded-full border-2 border-primary absolute -right-[14px] bottom-[150px] bg-white hidden sm:flex items-center justify-center"
				onClick={() => {
