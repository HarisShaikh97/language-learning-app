...
export default function UpNextWordsCard({ className }) {
	return (
		<div
			className={`absolute ${className} w-56 sm:w-80 bg-primary shadow-xl flex flex-col gap-5 px-5 py-5`}
		>
			...
			<div className="h-20 flex rounded bg-gray-100 hover:bg-gray-200 p-3 relative">
			...
			<Link
				className="h-10 flex items-center justify-center bg-blue-400 hover:bg-blue-300 text-white rounded font-semibold"
				href="/my-classes"
			>
				Continue
			</Link>
