...
export default function UpNextWordsCard() {
	...
	return (
		<div className="absolute top-32 left-[15px] w-80 rounded-2xl bg-primary border-b-8 border-blue-400 flex flex-col gap-5 px-5 py-5">
			...
			<Link className="h-14 flex items-center justify-center bg-blue-400 hover:bg-blue-300 border-b-4 border-blue-500 rounded-2xl font-semibold" href="/scenarios">
				Continue
			</Link>
		</div>
