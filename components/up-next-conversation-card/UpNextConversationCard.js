...
export default function UpNextConversationCard({ className }) {
	return (
		<div
			className={`absolute ${className} w-56 sm:w-80 bg-primary flex flex-col gap-5 px-5 py-5 shadow-xl`}
		>
			...
			<div className="h-20 flex items-center px-5 rounded bg-slate-500 bg-opacity-35">
				<p className="font-bold text-slate-300">
					No recommended conversations right now
				</p>
			</div>
			<div className="h-12 flex items-center justify-center text-white bg-blue-400 hover:bg-blue-300 rounded font-semibold">
				More conversations
			</div>
		</div>
	)
