		...
		<div className="hidden computer:flex flex-row items-center gap-5 mt-20">
			...
			>
				<div className="flex flex-col items-center justify-center gap-5">
					...
					<div className="h-[130px] w-[130px] rounded-full flex items-center justify-center bg-[#b1f7e3]">
						<div className="h-[110px] w-[110px] rounded-full bg-[#00a778] flex items-center justify-center">
			...
			>
				<div className="flex flex-col items-center justify-center gap-5">
					...
					<div className="h-[130px] w-[130px] rounded-full flex items-center justify-center bg-[#f5bcb9]">
						<div className="h-[110px] w-[110px] rounded-full bg-[#e46962] flex items-center justify-center">
